...
1. **Helperiai**
   ...
   - YAML naudotojams: įtraukite `[helpers/lt/helpers_lt.yaml]([https://github.com/Pho3niX90/solis_modbus](https://github.com/omenukas/battery-charging-models-for-Solis-inverters/blob/main/helpers/lt/helpers_lt.yaml)` **arba** `helpers/en/helpers_en.yaml` į `configuration.yaml.
